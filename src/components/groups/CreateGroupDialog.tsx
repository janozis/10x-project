...
export function CreateGroupDialog({ open, onOpenChange, onCreated }: CreateGroupDialogProps): JSX.Element {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent aria-labelledby="create-title" aria-describedby="create-desc">
        <DialogHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4" aria-busy={loading}>
          ...
          <div className="grid gap-2">
            ...
            <Textarea id="description" aria-invalid={!!form.formState.errors.description} aria-describedby="desc-error" {...form.register("description")} />
          ...
          <div className="grid gap-2">
            ...
            <Input id="lore_theme" aria-invalid={!!form.formState.errors.lore_theme} aria-describedby="lore-error" {...form.register("lore_theme")} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Input id="start_date" type="date" aria-invalid={!!form.formState.errors.start_date} aria-describedby="start-error" {...form.register("start_date")} />
            ...
            <div className="grid gap-2">
              ...
              <Input id="end_date" type="date" aria-invalid={!!form.formState.errors.end_date} aria-describedby="end-error" {...form.register("end_date")} />
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={loading} aria-disabled={loading}>{loading ? "Zapisywanie…" : "Utwórz"}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
