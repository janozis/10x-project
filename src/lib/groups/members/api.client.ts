...
export async function removeMember(groupId: UUID, userId: UUID): Promise<void> {
  await fetchJson<Record<string, never>>(`/api/groups/${groupId}/members/${userId}`, { method: "DELETE" });
}
