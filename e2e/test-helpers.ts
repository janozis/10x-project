 ...
 */
export function generateUniqueActivityName(prefix: string = 'Test Activity'): string {
  const timestamp = getTimestamp();
  return `${prefix} ${timestamp}`;
}
 ...
 */
export function generateUniqueCampDayName(prefix: string = 'Test Day'): string {
  const timestamp = getTimestamp();
  return `${prefix} ${timestamp}`;
}
 ...
 */
export function generateGroupData(overrides?: Partial<{
  name: string;
  description: string;
  lore_theme: string;
  start_date: string;
 ...
 */
export function generateActivityData(overrides?: Partial<{
  temat: string;
  cel: string;
  czas: string;
  miejsce: string;
 ...
 */
export function generateTaskData(overrides?: Partial<{
  title: string;
  dueDate: string;
  description: string;
  activityId: string;
